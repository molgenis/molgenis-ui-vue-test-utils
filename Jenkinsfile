pipeline {
    ...
    stages {
            ...
            steps {
                ...
                container('vault') {
                    script {
                        ...
                        env.CODECOV_TOKEN = sh(script: 'vault read -field=molgenis-ui-vue-test-utils secret/ops/token/codecov', returnStdout: true)
        ...
        stage('Release: [ master ]') {
            ...
            environment {
                ORG = 'molgenis'
                REPO_NAME = 'molgenis-ui-vue-test-utils'
